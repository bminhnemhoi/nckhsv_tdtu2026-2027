...
**Nói gì:**
> "Em chào cô. Em xin 20 phút: 2 phút em làm gì, 4 phút vấn đề, 6 phút phương pháp và kết quả có demo, 4 phút những chỗ em đã vấp và sửa, 2 phút em định nộp ở đâu, rồi 2 phút cuối em xin cô ba việc. Cô ngắt bất cứ lúc nào cũng được ạ.
>
> Em làm hệ thống đọc điện tim thai từ **một** điện cực dán trên bụng mẹ, tìm từng nhịp tim của bé, và — phần em coi là chính — tự biết khi nào nó không đáng tin để nói 'tôi không chắc' thay vì đưa ra một con số sai. Tên hệ thống là RelyFetal. Em huấn luyện trên 22 sản phụ, kiểm ngoài trên 60 bản ghi của một bộ khác, mã khoảng 27.700 dòng Python với 60 kiểm thử tự động."
...
>
> Các nhóm khác dùng 4 đến 32 điện cực và tách nguồn. Em hỏi ngược lại hai câu: nếu chỉ có một dây — để sau này thành miếng dán mẹ tự đeo — thì **mất bao nhiêu** so với bốn dây; và hệ thống có **tự biết** lúc nào nó không nhìn thấy tín hiệu không? Câu thứ hai em nghĩ là quan trọng hơn với bác sĩ — nhưng em chưa gặp bác sĩ nào để hỏi, đó là điều em muốn xin cô."
...
> "Đường ống có 5 bước: lọc 10–60 Hz pha-không, khử điện tim mẹ bằng mẫu trung vị co giãn từng nhịp, chọn kênh mù nhãn, một mạng tích chập thời gian nhỏ — 113 nghìn tham số, 0,48 MB, 4,35 mili-giây cho mỗi cửa sổ 4 giây trên CPU — cho ra xác suất từng mẫu, và một cổng từ chối dùng 12 chỉ số chất lượng tín hiệu cổ điển.
>
> Kết quả chính trên 22 sản phụ, F1 mức chủ thể, ghép ±50 mili-giây: phương pháp mạnh nhất hiện có mà em chạy lại được, Power-MF, dùng 4 kênh đạt 98,83; chính nó cắt xuống 1 kênh còn 86,71; mạng 1 kênh của em đạt 97,56. Nói đúng: em vẫn thua 4 kênh 1,27 điểm, khoảng tin cậy từ −3,08 đến +0,27, chưa có ý nghĩa; nhưng thắng 18 trên 22 bản. Bốn kênh đáng giá 12,12 điểm cho Power-MF và một kênh của em lấy lại 10,85 — tức 89,5 %, khoảng tin cậy 81 đến 103 % (`analysis/recovery_ratio.json`). Em chạy lại Power-MF bằng Octave và đối chiếu với số tác giả công bố: 99,40 so với 99,46.
>
> Trên bộ CinC 2013 mà mô hình chưa từng thấy, sau khi loại 15 bản trùng với dữ liệu huấn luyện còn 60 bản sạch: quy tắc chọn kênh cũ cho 74,28, quy tắc mới cho 82,01, cộng 7,73 với khoảng tin cậy 3,82 đến 12,41 (`analysis/dulieu_results.json`). Em sẽ nói ở phần vấp vì sao con số này phải gọi là giả thuyết chứ chưa phải kết quả xác nhận. Giờ em cho cô xem nó chạy."
...
**Dự phòng nếu demo hỏng:** ảnh chụp mới trong `demo/screenshots/` hiện chỉ có r01 và a09 (5 ảnh `01…05`); a02 **chưa có ảnh mới** — trước buổi gặp chụp tay `09_a02_the_so.png` và `10_a02_fhr.png` theo tên trong `HUONG_DAN_DEMO.md` mục 5, hoặc nói theo bảng in ra của `demo/run_check.py` (mục 6 của hướng dẫn). Chuyển không quá 30 giây.
...
>
> **Một, bộ kiểm tra có bản trùng với bộ huấn luyện.** Ban tổ chức CinC 2013 đã ghi điều này từ 2013 — Silva 2013 Bảng 1 ghi 25 bản từ ADFECGDB, Clifford 2014 cảnh báo nguyên văn về một nhóm huấn luyện trên ADFECGDB rồi kiểm trên set-a. Em đã đọc, đã ghi vào ghi chú đọc bài, rồi vẫn bỏ sót khi làm. Khi đo lại, 15 trong 75 bản là bản sao nguyên văn: tương quan chuẩn hoá đúng 1,0000, lệch nhịp 0,0 mili-giây, mỗi bản huấn luyện xuất hiện đúng 3 lần theo cửa sổ 0–60, 120–180, 240–300 giây (`analysis/DULIEU.md`). Cái mới của em không phải là biết có trùng, mà là chỉ đúng 15 bản nào và đo mức thổi phồng: 3,27 đến 7,18 điểm F1. Em loại 15 bản, số chính rớt khoảng 5 điểm, nhưng cải tiến chọn kênh trên dữ liệu sạch lại mạnh hơn số cũ. Cải tiến thật không sợ dữ liệu sạch.
>
> **Hai, em chạy lại Power-MF bằng Octave** vì không có MATLAB, và lúc đầu nó cho kết quả thấp hơn tác giả vài điểm. Em đoán nguyên nhân trước khi đo, và đoán sai. Đo lại thì ra lỗi cổng chuyển của em — hàm tìm đỉnh của Octave tràn bộ nhớ. Sửa xong: 99,40 so với 99,46 tác giả công bố (`baselines/powermf_published.json`). Từ đó em có luật: không phát biểu nguyên nhân trước khi có số.
>
> **Ba, quy tắc chọn kênh là chọn sau khi nhìn kết quả.** Em thử 7 quy tắc và ghi trước luật 'lấy quy tắc tốt nhất trong miền' — luật đó chỉ vào quy tắc *gate*. Gate trên 60 bản sạch cho 80,72, trượt hiệu chỉnh Holm với p 0,051. Quy tắc thắng, *peakprob* 82,01, là em chọn sau. Nó sống sót Holm trên cả họ 7 quy tắc với p 0,0039 và không có siêu tham số, nên em vẫn báo cáo — nhưng gọi là giả thuyết mạnh chưa xác nhận. Em đã thử hai đường cứu: tính lại trên thang logit ở 22 sản phụ — gate vẫn đứng đầu, peakprob hạng 3 (`analysis/xacnhan_results.json`); và tìm bộ thứ ba có nhãn để chạy đúng một lần — không có bộ công khai nào. Nên vấn đề hậu kiểm không biến mất; nó chỉ gỡ được bằng dữ liệu mới.
>
> **Bốn, em rút ba tuyên bố khác.** Dải lọc từng được ghi là cộng hơn mười điểm — đo lại trên đúng mô hình thì +2,44 ở kênh PSD với khoảng tin cậy chạm 0, và gần bằng 0 khi lấy trung bình 4 kênh. 'Đơn kênh hơn đa kênh' — sai, thua 1,27. Và kết luận 'khoảng cách ngoài miền là do không có tín hiệu, không phải do mô hình' — em rút, vì phép thử em dùng để nói 'không nhìn thấy tín hiệu' có âm tính giả 18 %, khoảng tin cậy 12 đến 25 %. Bốn phương pháp thích nghi miền đều thất bại là sự thật đo được; còn nguyên nhân khoảng cách 15 điểm giữa trong miền và ngoài miền thì em chưa trả lời được.
>
> Chỉ số lâm sàng STV cũng vậy: lệch 0,33 mili-giây trên dữ liệu trong miền nhưng lệch 20,5 trên CinC (`analysis/clinical_results.json`) — chưa dùng được làm máy đo độc lập. Khi cổng cho phép thì sai số điển hình 0,13 mili-giây, nên cổng từ chối là thứ làm chỉ số này có thể dùng được, chưa phải mô hình."
...
**Nói gì:**
> "Đóng góp em định nộp không phải 'một máy dò tốt hơn'. Là ba thứ có ranh giới: một phép đo — một kênh lấy lại 89,5 % lợi ích của bốn kênh, trên cùng bản ghi cùng bộ chấm; một cổng từ chối không dùng nhãn — đánh giá bỏ-một-chủ-thể trên 22 sản phụ, AUROC trong bản ghi 0,934, xếp đúng ba bản khó nhất vào ba hạng chót (`analysis/gate22_results.json`); và một bản kiểm toán bộ chuẩn — 15 bản trùng, mức thổi phồng, và mọi số báo cáo trên 60 bản sạch. Quy tắc chọn kênh đi kèm như giả thuyết mạnh.
>
> Nơi nộp thực tế: **Physiological Measurement** — Q2 theo Scimago 2024, không phải Q1, nhưng là nơi cộng đồng điện tim thai và chính CinC Challenge 2013 công bố; và **Computing in Cardiology 2027**, hạn dự kiến tháng 4/2027 — kỳ 2026 đã diễn ra rồi, em không kịp. Q1 như IEEE JBHI chỉ có cửa nếu em có một bộ có nhãn mới để chạy quy tắc chọn kênh đúng một lần; em ước cửa Q1 trong 6 tháng khoảng 15–20 %, không hơn.
>
> Ba tháng tới em làm: 3 hạt giống cho kết quả chính — hạt giống thứ hai đã có, 97,59 so với 97,56; tính lại số cổng từ chối trên 60 bản sạch; viết bản dài cho Physiological Measurement và bản 4 trang cho CinC 2027 trên 60 bản sạch. Hai việc em quyết định **không** làm nữa vì đã đo thấy đòn bẩy yếu: đổi kiến trúc — 7 họ cùng tham số cách nhau dưới 1 điểm (`analysis/kientruc_results.json`); và thích nghi miền không giám sát — 4 phương pháp đều hỏng (`adapt/adapt_results.json`)."
...
**Nói gì:**
> "Em xin cô ba việc. **Một**, nếu cô có liên hệ với khoa sản nào đang ghi CTG hoặc điện tim bụng, em xin được gặp một bác sĩ 30 phút — em cần biết bác sĩ cần chính xác bao nhiêu thì mới dùng được, và hỏi xem có thể xin dữ liệu có nhãn, hoặc nhờ chuyên gia kiểm nếu em tự chú thích 10–20 bản của một bộ công khai chưa có nhãn. Không có việc này thì em không lên được Q1 và cũng không có gì để nói với hội đồng về nhu cầu thật.
>
...
>
> Em muốn bài này có thực lực chứ không phải đẹp số. Mọi con số trong tờ tóm tắt truy ngược được về một tệp trên máy, và em gửi cô kho mã ngay hôm nay."
...
1. **"Em tóm tắt lại đề tài trong một phút được không?"**
   "Em đọc điện tim thai từ một điện cực trên bụng mẹ, tìm từng nhịp, và hệ thống tự chấm mức tin cậy để từ chối khi tín hiệu không đủ. Trên 22 sản phụ em đạt 97,56 so với 98,83 của phương pháp bốn kênh mạnh nhất em chạy lại được, và hơn chính phương pháp đó khi nó chỉ dùng một kênh 10,85 điểm. Trên 60 bản ghi chưa từng thấy em đạt 82,01. Cổng từ chối, đánh giá bỏ-một-chủ-thể, xếp đúng ba bản khó nhất vào ba hạng chót."
...
6. **"Cổng từ chối hoạt động thế nào, nó sai thì sao?"**
   "Mỗi đoạn 4 giây em tính 12 chỉ số chất lượng cổ điển — entropy, độ nhọn, tỉ lệ RR hợp lý, năng lượng dải thai… — đưa vào một bộ phân loại nhỏ ra xác suất 'đoạn này xấu'. Không dùng nhãn lúc chạy. Trên 22 sản phụ, đánh giá bỏ-một-chủ-thể, AUROC trong bản ghi 0,934, khoảng tin cậy 0,872 đến 0,981, và nó xếp đúng ba bản khó nhất vào ba hạng chót — ngẫu nhiên là 1 trên 1540. Nhưng 5 trong 24 quy tắc một đặc trưng đơn giản cũng xếp đúng ba bản đó, nên em không dám nói phải học mới làm được. Số cổng trên CinC em chưa tính lại trên 60 bản sạch nên em không đọc ra."

7. **"Rò rỉ dữ liệu là sao — em có chắc không? Người khác có bị không?"**
   "Ban tổ chức đã ghi từ 2013 rằng set-a có 25 bản từ ADFECGDB; cái em làm là đo để biết đúng bản nào. Em kiểm bằng tương quan chéo chuẩn hoá từng cặp và so chuỗi khoảng nhịp tham chiếu: 15 bản cho tương quan đúng 1,0000, lệch 0,0 mili-giây, cả 4 kênh đúng thứ tự; đối chứng dương là các bản cùng sản phụ đã biết chỉ cho 0,86–0,98; 60 bản còn lại cao nhất 0,62; hai cách cài đặt độc lập cùng kết quả. Về người khác: em đã rà 20 bài, 4 bài chắc chắn huấn luyện trên ADFECGDB và kiểm trên set-a, 2 bài nghi ngờ (`survey/RO_RI_VANLIEU.md`). Em sẽ nêu dè dặt trong bài, kèm trích dẫn Clifford 2014."
...
3. **Cô hỏi về một phương pháp em chưa thử** ("sao không dùng Transformer / học tự giám sát / dữ liệu tổng hợp / DANN, CORAL?"):
   > "Em chưa thử cái đó. Em ghi lại làm việc tiếp. Nếu cô hỏi em đoán, thì em đoán là … — nhưng đó là phỏng đoán, không phải kết quả, và em đã đoán sai một lần với Power-MF nên em không tin phỏng đoán của mình lắm."
...
| Ảnh dự phòng | 5 ảnh mới (r01, a09) có sẵn; **chụp tay thêm a02** trước buổi gặp | `screenshot.py` lần cuối báo `ok: false` — không tin vào ảnh 06–12 |
| 1 trang tóm tắt in giấy | 2 bản (1 cho cô, 1 cho mình) | `docs/TOM_TAT_1_TRANG.md` |
| Kho mã | Link GitHub sẵn trong tin nhắn nháp | https://github.com/bminhnemhoi/nckhsv_tdtu2026-2027 — commit mới nhất 7dd2dac |
...
>
> 1. Giới thiệu giúp em một bác sĩ sản hoặc khoa sản đang ghi CTG / điện tim bụng để em xin phỏng vấn 30 phút, và hỏi khả năng xin dữ liệu có nhãn hoặc nhờ chuyên gia kiểm nhãn nếu em tự chú thích một bộ công khai.
