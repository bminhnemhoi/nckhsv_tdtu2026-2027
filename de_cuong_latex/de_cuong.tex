...
\smallskip
\textbf{Bản 3.5 (vòng 7) rút thêm:} mọi con số CinC 2013 tính trên \textbf{75 bản ghi} (71,21 / 79,40 /
86,87 / 85,60 / +8,18 / +7,47\dots) --- 15 bản set-a là bản sao nguyên văn của 5 bản ADFECGDB dùng huấn luyện.
\textbf{Điều này ban tổ chức đã ghi nhận từ 2013} (Silva 2013, Bảng 1; Clifford 2014, Bảng 2 và lời cảnh báo
về Rodrigues), câu cảnh báo đó nằm ngay trong ghi chú đọc bài của nhóm (p20) mà nhóm bỏ sót; nhóm chỉ xác
định bằng đo lường \emph{đúng 15 bản nào} và mức thổi phồng 3,27--7,18 điểm. Số đúng: \textbf{74,28} (PSD mù
nhãn, 22 ca) trên \textbf{60 bản sạch}; quy tắc \texttt{peakprob} 82,01 là giả thuyết hậu kiểm. Cũng rút:
``mô hình không phải nút thắt'' (phép thử nhìn thấy có âm tính giả 18\,\%), ``Physiological Measurement là
Q1'' (Scimago 2024: Q2/Q3). Chi tiết ở hộp đầu \S\ref{sec:cinc75}.
