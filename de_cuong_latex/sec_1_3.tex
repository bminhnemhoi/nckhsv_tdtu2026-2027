...
Mô hình của nhóm đạt macro F1 \tot{99,21} trên ADFECGDB khi tách theo bản ghi, và tổng quát được sang
\tot{93,30} trên 10 sản phụ \textbf{thai kỳ} chưa từng thấy (Silesia B1). Nhưng khi chuyển sang một hệ ghi
khác (PhysioNet/CinC 2013) mà không tinh chỉnh thì chỉ còn \xau{77,34}, và quan trọng hơn con số trung bình
là hình dạng phân bố: bốn trên mười bản ghi đạt F1 tuyệt đối 100\%, ba bản khác sụp xuống dưới 50\%.
