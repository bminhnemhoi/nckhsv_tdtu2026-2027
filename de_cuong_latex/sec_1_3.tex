...
dự báo lỗi mô hình với AUROC \xau{0,566} ngoài miền, so với \tot{0,929} của chỉ số cổ điển, và gộp vào
còn làm giảm. Nhóm cũng chứng minh bằng số rằng $H_0$ của lọc dưới mức \textbf{trùng khớp 100\%} với
độ nhô đỉnh cổ điển.

\item \textbf{Dữ liệu là đòn bẩy lớn nhất, và độ tin cậy là rào cản thật.}
Mô hình học trên 5 ca đạt macro F1 \tot{99,21} trên ADFECGDB khi tách theo bản ghi, nhưng khi chuyển sang
một hệ ghi khác (PhysioNet/CinC 2013) chỉ còn \xau{77,34} với phân bố lưỡng cực: ba trên mười bản ghi sụp
dưới 50\%. Huấn luyện lại trên \textbf{22 sản phụ} --- thêm 17 ca cùng bệnh viện, trong đó 10 ca thai kỳ ---
nâng thai kỳ từ 93,30 lên \tot{97,15} ($p = 0{,}037$) và nâng CinC 2013 từ 77,34 lên \tot{90,34}
($p = 0{,}016$), \textbf{không còn bản ghi nào dưới 50}. Nhưng ở 90 vẫn còn cách 99 trong miền, và hệ thống
vẫn cần biết khi nào nó sai.
\end{enumerate}
...
F1 phần còn lại từ 62,0 lên 69,4, và bản demo bắt đúng hai bản ghi tệ nhất mà không bỏ lọt bản ghi tốt
nào.
...
\item[C3 --- Cổng từ chối trả lời cho bộ dò fQRS đơn kênh, kèm kết quả phủ định có kiểm soát về đồng
điều bền vững.] Cổng xây trên độ tự tin của mô hình và tính hợp lý của nhịp. Phần topo là thử nghiệm có
kiểm soát đầu tiên của phân tích dữ liệu topo trên tín hiệu tim thai mà nhóm tìm được, và kết quả là
\textbf{không có lợi ích} --- được công bố nguyên trạng.
\end{description}
\end{ghichu}
