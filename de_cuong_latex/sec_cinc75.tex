...
\input{sec_cinc60.tex}

\subsubsection{Các bảng 75 bản ghi của bản 3.4 --- đã rút, giữ lại để đối chiếu}
\label{sec:cinc75_darut}

Toàn bộ phần còn lại của mục này là \textbf{tư liệu lịch sử}. Các bảng và hình dưới đây tính trên 75
bản ghi set-a, tức có chứa 15 bản là bản sao dữ liệu huấn luyện, nên \textbf{mọi con số trong đó đều
đã bị rút}: 71,21 / 79,40 / 86,87 / 74,09 / 69,33 / 80,70 / 62,82 / $+8{,}18$ / $+7{,}47$ / $+6{,}20$
và tỉ lệ 22/75. Nhóm giữ chúng nguyên trạng thay vì xoá, để người đọc đối chiếu được mức thổi phồng
với bảng \ref{tab:cinc60}. Số hiện hành nằm ở \S\ref{sec:cinc60}.
...
\subsubsection{Vì sao mẫu 10 bản ghi bị lệch, và lệch theo hai hướng \textnormal{\xau{(số 75 bản --- đã rút)}}}
...
xuất hiện ở đây làm ví dụ về chính lỗi này. \textit{(Bản 3.4 viết tiếp: ``mọi bảng từ đây trở đi dùng
79,40 (75 bản ghi, PSD mù nhãn) làm con số CinC 2013''. Câu đó \textbf{cũng đã bị rút} ở bản 3.5: con
số CinC 2013 của đề tài nay là \textbf{74,28 trên 60 bản sạch} --- \S\ref{sec:cinc60}.)}
\end{ghichu}

\subsubsection{Điều 75 bản ghi nói mà 10 bản ghi không nói được \textnormal{\xau{(số 75 bản --- đã rút)}}}

\textit{Cảnh báo: mọi con số trong bốn điểm dưới đây tính trên 75 bản ghi và \textbf{đã bị rút}. Bản
tương ứng trên 60 bản sạch nằm ở \S\ref{sec:cinc60}: PSD 74,28, oracle 83,60, khoảng cách 9,32 điểm,
PSD chọn trúng kênh oracle ở 17/60 bản, 16/60 bản còn dưới 50, hiệu số 22 ca trừ 5 ca là $+10{,}24$
$[+7{,}13;\ +13{,}60]$.}

\begin{canhbao}
\xau{Bốn nhận định dưới đây được viết cho bản 3.4 trên 75 bản ghi và ĐÃ RÚT về mặt con số.} Số đúng trên 60 bản sạch (\S\ref{sec:cinc60}): PSD 74,28 · oracle 83,60 · dư địa chọn kênh 9,32 điểm · PSD chọn trúng oracle 17/60 · vẫn còn 16 bản dưới 50 (mô hình 22 ca). Kết luận \emph{định tính} của cả bốn ý giữ nguyên; giữ nguyên văn để đối chiếu với lịch sử.
\end{canhbao}
\begin{enumerate}[leftmargin=1.6em,itemsep=4pt]
\item \textbf{Sụp đổ xuyên hệ ghi CHƯA được chữa.} Với 75 bản ghi (đã rút; 60 bản sạch cho cùng kết luận), vẫn còn \textbf{16 bản ghi dưới 50}
...
79,40 \xau{(75 bản, đã rút --- trên 60 bản sạch: 83,60 và 74,28)}. Khoảng cách \textbf{7,47 điểm} \xau{(60 bản sạch: 9,32)} chỉ do chọn sai kênh. Trong miền khoảng cách này là 0,02--1,90 điểm.
...
không đổi kết luận nào. Bản 3.4 \emph{đã} báo cáo 75 bản ghi làm số chính vì quy tắc loại kia dựa trên một nguồn thứ
cấp mà nhóm chưa tự kiểm chứng; \xau{bản 3.5 dùng 60 bản sạch làm số chính} (\S\ref{sec:cinc60}), biến thể 53 bản (loại thêm 7 bản chú thích sai) chỉ để đối chiếu.
\end{enumerate}
