...
\item \textbf{P9} một phần: demo Gradio chạy được, kiểm thử ba tầng, ảnh chụp thật (\S\ref{sec:demo}).
Còn API và Docker.
\end{itemize}
Chưa động tới: P3 (huấn luyện lại trên 22 ca), P7 (tiền huấn luyện FECGSYNDB), P8 (đường cong F1--SNR),
P10--P11 (viết và nộp bài).
\end{ghichu}
...
Bản demo web & Gradio, năm tầng tín hiệu, đèn tin cậy, kiểm thử ba tầng & \tot{Đã có} \\
API và đóng gói Docker & & Phase P9 \\
\bottomrule
\end{tabular}
\end{table}
